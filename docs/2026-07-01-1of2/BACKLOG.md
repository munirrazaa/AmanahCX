...
- Call Recordings module: unified bot+human recordings list, role-scoped, legal hold, audio player, transcript — DONE 2026-07-01
- CX Insights dashboard: 10 KPI cards, 6 recharts charts, topic word cloud, date-grid heatmap, topic-filtered recordings, All/Bot/Human filter — DONE 2026-07-01
- operations_admin role (rank 35): cross-dept read-only oversight, CX Insights + Recordings access — DONE 2026-07-01
- HTML reference v2.1: Sales flow (10 steps), role login mockups (4 roles × 3 depts), sector CRM fields (5 industries) — DONE 2026-07-01

### P1 — Do Now
- CSAT survey on ticket close (customer satisfaction score) — all top CRMs have this
- Customer reopen window 48h after resolution
- Escalation status flag (agent → manager)
- Pending status on tickets (waiting on external body)
- Custom fields builder (required for all 5 sectors: Insurance, Banking, Telecom, Utilities, Retail)

### P2 — Do Soon
- Knowledge base article suggestion on ticket open (Zendesk AI assist / Freshdesk Freddy)
- Exec summary / C-level 1-page report for Line Manager
- Cross-dept visibility toggle for operations_admin
- Sales CX Insights (pipeline conversion rate in CX Insights dashboard)

### P3 — Backlog
- Wallboard / real-time public display
- Gamification / agent leaderboard widget
- Omnichannel: WhatsApp, chat ticket creation
- Field technician dispatch integration (Utilities sector)
- Order management integration (Retail/E-Commerce sector)
- Regulatory report export (SBP QCR, PTA complaint format)
