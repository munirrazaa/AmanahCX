...
- Call recording (with a spoken consent notice) is now fully active, storing audio on a small self-hosted bucket on the relay server, with automatic cleanup so storage never fills up.
