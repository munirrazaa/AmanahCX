...
- For Voice Bot specifically, the Super Admin gets a direct editor right there in the same screen — bot name, greeting, tone, speaking speed, and guardrails — so the whole thing can be configured without the tenant admin ever touching it.
