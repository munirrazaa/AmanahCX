...
export interface SectorConfig {
  ...
  defaultModules: string[];     // module keys auto-licensed when this sector is picked at tenant creation
  defaultFeatures: string[];    // feature keys auto-entitled alongside defaultModules
}
